...
export class IndCaracterizacionComponent implements OnInit {
  ...
  divisiones1=['Almacenes ', 'Bathrooms and Kitchen', 'Comercial  Colombia', 'Funciones Transversales', 'Insumos Industriales y Energias', 'Mesa Servida', 'Superficies, materiales y pinturas'];
  ...
  async ngOnInit() {
    ...
    this.divisiones2.push({label:' total',value:' total'})
    this.divisiones3.push({name:' total',code:cont})
  ...
  CardsClasificacion(){
    ...
    this.CaracterizacionView1.forEach(element => {
      if(this.radioGra0==0){
        if(this.selectArea.length==0 || this.selectArea.toString()==' total')this.ContCardsClasificacion(element);
        if(this.selectArea==element.padrenombre  && this.selectArea.toString()!=' total')this.ContCardsClasificacion(element);
      }
  ...
  primeraGrafica(){
    ...
    this.datosGrafica1.push({name:' total',series:[{name:'Sexo masculino',value:sum1},{name:'Sexo femenino',value:sum2}]})
  }
    ...
    this.datosGrafica1.push({name:' total',series:[{name:'Lugar fuera',value:sum1},{name:'Lugar adentro',value:sum2}]})
  }
    ...
    this.datosGrafica1.push({name:' total',series:[{name:'Jornada normal',value:sum1},{name:'Jornada extra',value:sum2}]})
  }
...
resetVarGraf2(){
  ...
  segundaGrafica(){
    ...
    if(this.radioGra2_1==0){
      ...
      this.datosGrafica2.push({name:'Almacenes ',series:this.funcRangoFechaEdad(this.ContFechaNacimiento_1)})
      this.datosGrafica2.push({name:'Bathrooms and Kitchen',series:this.funcRangoFechaEdad(this.ContFechaNacimiento_2)})
      this.datosGrafica2.push({name:'Comercial  Colombia',series:this.funcRangoFechaEdad(this.ContFechaNacimiento_3)})
      ...
      this.datosGrafica2.push({name:' total',series:this.funcRangoFechaEdad(this.ContFechaNacimiento_total)})

  }

    if(this.radioGra2_1==1){
      this.datosGrafica2.push({name:'Almacenes ',series:this.funcRangoFechaAntiguedad(this.ContFechaIngreso_1)})
      this.datosGrafica2.push({name:'Bathrooms and Kitchen',series:this.funcRangoFechaAntiguedad(this.ContFechaIngreso_2)})
      this.datosGrafica2.push({name:'Comercial  Colombia',series:this.funcRangoFechaAntiguedad(this.ContFechaIngreso_3)})
      ...
      this.datosGrafica2.push({name:' total',series:this.funcRangoFechaAntiguedad(this.ContFechaIngreso_total)})
    ...
    if(this.radioGra2_1==2){
      ...
      this.datosGrafica2.push({name:'Almacenes ',series:this.funcRangoHoraAccidente(this.ContHoraAccidente_1)})
      this.datosGrafica2.push({name:'Bathrooms and Kitchen',series:this.funcRangoHoraAccidente(this.ContHoraAccidente_2)})
      this.datosGrafica2.push({name:'Comercial  Colombia',series:this.funcRangoHoraAccidente(this.ContHoraAccidente_3)})
      ...
      this.datosGrafica2.push({name:' total',series:this.funcRangoHoraAccidente(this.ContHoraAccidente_total)})
  }
...
reinciarVariable(){
  ...
  this.datos4_1.padrenombre='Almacenes ';
  ...
  this.datos4_3.padrenombre='Comercial  Colombia';
...
DatosGrafica6(){
  ...
  sextaGrafica(){
    this.datosGrafica6=[]
    this.datosGrafica6.push({name:'Almacenes ',series:this.order(this.graf6_1)})
    this.datosGrafica6.push({name:'Bathrooms and Kitchen',series:this.order(this.graf6_2)})
    this.datosGrafica6.push({name:'Comercial  Colombia',series:this.order(this.graf6_3)})
  ...
  contTotal(datos){
    ...
    datos.push({name:' total',series:datosGrafica_total})
