...
export class FactorCausalComponent implements OnInit {
  ...
  changeSelection(selectForm: string, selection:boolean){
    ...
    // console.log(this.formDesempeno.value[selectForm]);
    console.log(this.formDesempeno.value);
    console.log(this.formDesempeno.value.Dq1);

    if(this.formDesempeno.value.Dq2||this.formDesempeno.value.Dq3||this.formDesempeno.value.Dq14){
      this.identificacionFC[0].selectable=true;      
    }else{
      this.identificacionFC[0].selectable=false;      
    }

    if(this.formDesempeno.value.Dq15){
      this.identificacionFC[1].selectable=true;      
    }else{
      this.identificacionFC[1].selectable=false;      
    }

    if(this.formDesempeno.value.Dq12||this.formDesempeno.value.Dq13||this.formDesempeno.value.Dq14){
      this.identificacionFC[2].selectable=true;      
    }else{
      this.identificacionFC[2].selectable=false;      
    }

    if(this.formDesempeno.value.Dq5||this.formDesempeno.value.Dq6||this.formDesempeno.value.Dq8||this.formDesempeno.value.Dq10){
      this.identificacionFC[3].selectable=true;      
    }else{
      this.identificacionFC[3].selectable=false;      
    }

    if(this.formDesempeno.value.Dq9||this.formDesempeno.value.Dq10||this.formDesempeno.value.Dq11){
      this.identificacionFC[4].selectable=true;      
    }else{
      this.identificacionFC[4].selectable=false;      
    }

    if(this.formDesempeno.value.Dq1||this.formDesempeno.value.Dq7||this.formDesempeno.value.Dq8){
      this.identificacionFC[5].selectable=true;      
    }else{
      this.identificacionFC[5].selectable=false;      
    }

    if(this.formDesempeno.value.Dq1||this.formDesempeno.value.Dq6||this.formDesempeno.value.Dq8||this.formDesempeno.value.Dq10||this.formDesempeno.value.Dq12||this.formDesempeno.value.Dq14){
      this.identificacionFC[6].selectable=true;      
    }else{
      this.identificacionFC[6].selectable=false;      
    }
