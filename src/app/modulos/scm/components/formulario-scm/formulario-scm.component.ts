    ...
    ngOnInit() { 
        ...
        if (this.caseSelect) {
            ...
            if (this.caseSelect != null) {
                ...
                fq.filterList = [{ criteria: Criteria.EQUALS, field: 'id', value1: this.caseSelect.pkUser, value2: null }];
                // //console.log(fq);
                ...
                fq.filterList = [{ criteria: Criteria.EQUALS, field: 'id', value1: this.caseSelect.pkJefe, value2: null }];
                // //console.log(fq);
                this.empleadoService.findByFilter(fq).then(
                    resp => {
                        let select = <Empleado>(resp['data'][0]);
                ...
                fq.filterList = [{ criteria: Criteria.EQUALS, field: 'id', value1: this.caseSelect.pkBusinessPartner, value2: null }];
                // //console.log(fq);
                this.empleadoService.findByFilter(fq).then(
                    resp => {
                        let select = <Empleado>(resp['data'][0]);
